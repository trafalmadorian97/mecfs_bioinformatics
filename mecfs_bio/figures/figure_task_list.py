...
ALL_FIGURE_TASKS: list[Task] = [
    ...
    DECODE_SEROPOSITIVE_RA_STANDARD_ANALYSIS.tasks.sldsc_tasks.partitioned_tasks[MULTI_TISSUE_GENE_EXPRESSION_REF].plot_task_unwrap,
    DECODE_SEROPOSITIVE_RA_STANDARD_ANALYSIS.tasks.sldsc_tasks.partitioned_tasks[MULTI_TISSUE_GENE_EXPRESSION_REF].multiple_testing_task_markdown,
