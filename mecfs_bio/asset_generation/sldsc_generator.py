...
from mecfs_bio.build_system.task_generator.sldsc_task_generator import SLDSCTaskGenerator, PartitionedLDScoresRecord


def standard_sldsc_task_generator(sumstats_task: Task, base_name: str)-> SLDSCTaskGenerator:
