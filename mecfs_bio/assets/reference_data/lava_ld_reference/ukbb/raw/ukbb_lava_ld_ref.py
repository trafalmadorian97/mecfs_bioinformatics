"""
Task to download LD reference data from UK Biobank for use in LAVA
For serius analysis on any European population, the authors recommend using this LD reference over the 1000 genomes referencce
"""
...
# Recommended download commands from LAVA README
...
LAVA_UKBB_LD_REF = DownloadFilesIntoDirectoryTask(
