from mecfs_bio.assets.reference_data.rna_seq_data.yu_drg.raw.yu_drg_raw_counts_rdata import (
    YU_DRG_SRC1_RDATA,
)
from mecfs_bio.build_system.task.extract_dataframe_from_rdata_task import (
