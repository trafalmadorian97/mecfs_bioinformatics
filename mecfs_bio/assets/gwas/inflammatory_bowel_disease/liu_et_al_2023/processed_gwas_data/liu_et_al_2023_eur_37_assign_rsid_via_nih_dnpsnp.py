...
from mecfs_bio.assets.gwas.inflammatory_bowel_disease.liu_et_al_2023.processed_gwas_data.liu_et_al_2023_eur_liftover_to_37_parquet import (
...
LIU_ET_AL_2023_ASSIGN_RSID_VIA_DBSNP_NON_HARMONIZED = (
    JoinDataFramesTask.create_from_result_df(
        asset_id="liu_et_al_2023_ibd_eur_assign_rsids_via_dnpsnp_non_harmonized",
        result_df_task=LIU_ET_AL_2023_IBD_LIFTOVER_TO_37_PARQUET,
