"""Demonstrator: polyfun-vs-uniform explainability at the DecodeME chr20:47.7Mb
locus.

Same locus, sumstats, sample size, palindrome strategy, and chrom range as the
with_palindromes chr20_47 fine-mapping module, so the eight SUSIE runs here
...
POLYFUN_EXPLAIN_CHR20_47 = generate_assets_polyfun_explain_fine_map(
    chrom=20,
    pos=47_653_230,
