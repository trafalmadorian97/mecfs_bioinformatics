"""Demonstrator: polyfun-vs-uniform explainability at the DecodeME chr6:97.5Mb
locus.

Same locus, sumstats, sample size, palindrome strategy, and chrom range as the
with_palindromes chr6_97 fine-mapping module, so the eight SUSIE runs here
...
POLYFUN_EXPLAIN_CHR6_97 = generate_assets_polyfun_explain_fine_map(
    chrom=6,
    pos=97_505_620,
