...
POLYFUN_EXPLAIN_CHR1_174 = generate_assets_polyfun_explain_fine_map(
    ...
    # The DecodeME sumstats were lifted 38 -> 37, so the gwaslab SNPID keeps the
    # original hg38 position while POS holds hg19. Surface it as pos_hg38 so
    # readers can cross-reference the (hg38) DecodeME summary statistics.
