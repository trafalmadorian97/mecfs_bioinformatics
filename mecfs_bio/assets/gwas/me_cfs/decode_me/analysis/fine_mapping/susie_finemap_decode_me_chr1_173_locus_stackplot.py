...
from mecfs_bio.build_system.task.susie_stacked_plot_task import SusieStackPlotTask, BinOptions
from mecfs_bio.build_system.task.susie_trackplot_task import RegionSelectDefault

DECODE_ME_GWAS_1_SUSIE_FINEMAP_CHR1_173_000_001_LOCUS_STACKPLOT= SusieStackPlotTask.create(
