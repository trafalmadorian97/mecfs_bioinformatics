"""Polyfun-vs-uniform explainability at the DecodeME chr20:47.7Mb locus, with the
...
polyfun_explainability.susie_explain_decode_me_37_chr20_47_653_230, so the two sets of
credible sets differ only in the prior. The contrast attributes the prior to
annotations with the DecodeME tau that scored chr20 (fit on the odd
...
POLYFUN_EXPLAIN_CHR20_47_L2_SLDSC_PRIOR = generate_assets_polyfun_explain_fine_map(
    chrom=20,
    pos=47_653_230,
