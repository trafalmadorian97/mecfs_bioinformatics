"""Polyfun-vs-uniform explainability at the DecodeME chr6:26.2Mb locus, with the
...
polyfun_explainability.susie_explain_decode_me_37_chr6_26_215_000, so the two sets of
...
POLYFUN_EXPLAIN_CHR6_26_L2_SLDSC_PRIOR = generate_assets_polyfun_explain_fine_map(
    chrom=6,
    pos=26_215_000,
