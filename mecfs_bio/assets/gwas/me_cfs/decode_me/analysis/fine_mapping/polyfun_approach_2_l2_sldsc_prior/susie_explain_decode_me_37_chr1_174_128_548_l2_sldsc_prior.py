"""Polyfun-vs-uniform explainability at the DecodeME chr1:174.1Mb locus, with the
...
polyfun_explainability.susie_explain_decode_me_37_chr1_174_128_548, so the two sets of
credible sets differ only in the prior. The contrast attributes the prior to
annotations with the DecodeME tau that scored chr1 (fit on the even
...
POLYFUN_EXPLAIN_CHR1_174_L2_SLDSC_PRIOR = generate_assets_polyfun_explain_fine_map(
    chrom=1,
    pos=174_128_548,
