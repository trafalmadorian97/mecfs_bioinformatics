...
BUILD_38_DECODE_ME_S_LDSC_ALL_TABLES_FDR_ZIP = ZipDirTask.create(
    source_dir_task=BUILD_38_DECODE_ME_S_LDSC_ALL_TABLES_FDR_COMBINED,
    asset_id="decode_me_sldsc_fdr_archive_build_38",
)
