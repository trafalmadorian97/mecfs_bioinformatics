...
from mecfs_bio.build_system.task.convert_dataframe_to_markdown_task import ConvertDataFrameToMarkdownTask
...
from mecfs_bio.build_system.task.pipes.rename_col_by_position_pipe import RenameColByPositionPipe
...
DECODE_ME_GWAS_1_HERITABILITY_BY_LDSC_MD =ConvertDataFrameToMarkdownTask.create_from_result_table_task(
