"""
Harmonize DecodeME GWAS data at the chr1 locus with the reference LD matrix by matching on rsid
"""
...
DECODE_ME_HARMONIZE_WITH_CHR1_173_000_001_LD = HarmonizeGWASWithReferenceViaRSIDTask.create(
