...
from mecfs_bio.assets.gwas.me_cfs.decode_me_male.raw.decode_me_male_raw import (
    DECODE_ME_GWAS_MALE_TASK,
)
from mecfs_bio.build_system.meta.asset_id import AssetId
from mecfs_bio.build_system.task.filter_snps_task import FilterSNPsTask

DECODE_ME_MALE_FILTER_SNPS_TASK = FilterSNPsTask.create(
