...
DECODE_ME_GWAS_INFECTIOUS_ONSET_TASK = OSFRetrievalTask(
    meta=GWASSummaryDataFileMeta(
        id=AssetId("decode_me_gwas_infectious_onset_raw"),
        trait="ME_CFS",
        project="DecodeME_infectious_onset",
        sub_dir="raw",
        project_path=PurePath("DecodeME Summary Statistics")
        / "gwas_1_infectious_onset.regenie.gz",
