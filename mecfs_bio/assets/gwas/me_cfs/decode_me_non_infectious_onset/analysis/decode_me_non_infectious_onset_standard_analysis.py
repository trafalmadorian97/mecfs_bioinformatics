...
from mecfs_bio.assets.gwas.me_cfs.decode_me_non_infectious_onset.processed.filtered_snps_decode_me_non_infectious_onset import (
    DECODE_ME_NON_INFECTIOUS_ONSET_FILTER_SNPS_TASK,
)
...
DECODE_ME_NON_INFECTIOUS_ONSET_STANDARD_ANALYSIS = (
    concrete_standard_analysis_generator_no_rsid(
        base_name="decode_me_non_infectious_onset",
        raw_gwas_data_task=DECODE_ME_NON_INFECTIOUS_ONSET_FILTER_SNPS_TASK,
        fmt="regenie",
        sample_size=5_841 + 259_909,
        pre_pipe_after_rsid_assignment=ComputePIfNeededPipe(),
        phenotype_info_for_ldsc=DECODE_ME_NON_INFECTIOUS_ONSET_PHENOTYPE_INFO,
    )
)
