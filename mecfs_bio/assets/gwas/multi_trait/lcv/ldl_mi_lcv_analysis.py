...
LDL_HARMONIZE_WITH_MI = HarmonizeGWASWithReferenceViaAlleles.create(
    asset_id="ldl_willer_harmonized_with_mi",
    gwas_data_task=WILLER_ET_AL_EUR_LDL_STANDARD_ANALYSIS.magma_tasks.parquet_file_task,
...
LDL_MI_LCV_ANALYSIS = LCVTask.create(
    asset_id="ldl_willer_mi_lcv_analysis",
