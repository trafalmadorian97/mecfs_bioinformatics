...
from mecfs_bio.build_system.task.magma.magma_clustermap_task_v2 import ExpressionMatrixClusterMapTaskV2
...
SCH_PGC_2022_MAGMA_CLUSTER_MAP_V2= ExpressionMatrixClusterMapTaskV2.create_standard_gene_magma_heatmap(
    ...
    gene_specificity_matrix_source=SpecificityMatrixSource(GTEx_V10_MEDIAN_TISSUE_EXPRESSION_RNA_SEQ_PREP_FOR_MAGMA,
                                                           pipe=DropColPipe(
                                                               ["Average"]
                                                           ),
                                                           gene_col="Gene"
                                                           ),
    extracted_magma_gene_results_source=GeneInfoSource(SCH_PGC_2022_STANDARD_ANALYSIS.magma_tasks.inner.gene_analysis_extracted_result_task,
                                                               pipe=IdentityPipe(),
                                                                   gene_col=MAGMA_GENE_COL
                                                       ),
    gene_thesaurus_source=GeneInfoSource(GENE_THESAURUS,
                                                     pipe=IdentityPipe(),
                                                     gene_col="Gene stable ID"
                                         )
)
# SCH_PGC_2022_MAGMA_CLUSTER_MAP_V2=ExpressionMatrixClusterMapTaskV2(
#     meta=SimpleFileMeta("sch_pgc_2022_cluster_map_v2"),
#     specificity_matrix_source=SpecificityMatrixSource(
#         task=GTEx_V10_MEDIAN_TISSUE_EXPRESSION_RNA_SEQ_PREP_FOR_MAGMA,
#         pipe=DropColPipe(
#         ["Average"]
#     ),
#         gene_col="Gene"
