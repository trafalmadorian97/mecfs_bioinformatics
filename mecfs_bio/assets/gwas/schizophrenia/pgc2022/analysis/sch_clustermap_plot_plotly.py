...
from mecfs_bio.build_system.task.magma.magma_clustermap_task import ExpressionMatrixClusterMapTask, TopGenesMode, \
    ...
    ExtraSeabornPlotOptions, GeneLabelingSpec, AuxGeneNamingDFSpec, ExtraPlotlyImshowPlotOptions
from mecfs_bio.build_system.task.pipes.drop_col_pipe import DropColPipe

SCH_PGC_2022_MAGMA_CLUSTER_MAP_PLOTLY=ExpressionMatrixClusterMapTask.create(
    ...
    vlimspec=VlimForGeneWiseSpec(max_multiple=4),
