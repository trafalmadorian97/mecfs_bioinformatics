...
PIRRUCCELLO_EXTRACTED_RA_FAC_DATA = ExtractFromZipTask.create_from_zipped_gwas_data(
    PIRRUCCELLO_RAW_RIGHT_HEART_DATA,
    asset_id="pirruccello_et_al_2022_extracted_ra_fac_data",
    file_to_extract="invnorm_rafac.tsv.gz",
    sub_dir="extracted",
    read_spec=DataFrameReadSpec(
        DataFrameTextFormat("\t", schema_overrides={"GENPOS": pl.String()})
    ),
)
