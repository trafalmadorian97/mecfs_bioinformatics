...
MILLION_VETERANS_EUR_LDL_MAGMA_TASKS = MagmaTaskGeneratorFromRaw.create(
    ...
    sample_size=404741,  # source: data file
    fmt=GWASLabColumnSpecifiers(
        rsid="rsid",  # note: RSIDS do not change with genome build, so this column is valid regardless of any downstream genome build conversion
        OR=None,
        se="standard_error",
        chrom="chromosome",
