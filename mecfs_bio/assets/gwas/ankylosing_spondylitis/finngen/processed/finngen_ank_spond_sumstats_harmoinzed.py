...
from mecfs_bio.build_system.task.gwaslab.gwaslab_create_sumstats_task import (
    ...
    GWASLabCreateSumstatsTask, GwasLabTransformSpec, HarmonizationOptions, GWASLabVCFRef,
)
...
FINGNEN_ANK_SPOND_SUMSTATS_HARMONIZED = GWASLabTransformSumstatsTask.create_from_source_task(
