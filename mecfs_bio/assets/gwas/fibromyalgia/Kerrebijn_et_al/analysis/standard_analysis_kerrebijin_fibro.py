...
KERREBIJN_ET_AL_FIBRO_STANDARD_ANALYSIS = concrete_standard_analysis_generator_assume_already_has_rsid(
    ...
    pre_pipe=CastPipe(target_column="n_eff",type=narwhals.Int64(), new_col_name="n_eff"),
