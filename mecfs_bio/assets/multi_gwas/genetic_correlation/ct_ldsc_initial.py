...
from mecfs_bio.build_system.task.gwaslab.gwaslab_genetic_corr_by_ct_ldsc_task import (
    ...
    SumstatsSource, BinaryPhenotypeSampleInfo,
)
    ...
    sources=[
        SumstatsSource(
            ...
            sample_info=BinaryPhenotypeSampleInfo(
                ...
                estimated_population_prevalence=0.6, # See Samms and Ponting: https://pmc.ncbi.nlm.nih.gov/articles/PMC12120426/#:~:text=our%20estimated%20ME/CFS%20prevalence%20in%20the%20UK%20then%20rises%20from%20330%2C000%20to%20410%2C000%20(0.6%25)
            )
        ),
        SumstatsSource(
        ...
        SCH_PGC_2022_STANDARD_ANALYSIS.magma_tasks.sumstats_task,
            alias="schizophrenia",
            pipe=SetColToConstantPipe(
                GWASLAB_SAMPLE_SIZE_COLUMN, constant=58749,  # from summary statistics file
            ),  # True total sample size. From Gwas catalog
        ),
        ...
        alias="asthma",
            ...
            SetColToConstantPipe(
                GWASLAB_SAMPLE_SIZE_COLUMN, constant=393859,  # from summary statistics file,
            ),  # True total sample size. From Gwas catalog
            ComputeBetaPipe(),
            ComputeSEPipe()
        ]),
