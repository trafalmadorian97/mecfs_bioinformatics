...
from mecfs_bio.build_system.data_manipulation.xr_gene_dataset import XR_TISSUE_DIMENSION, XR_SPECIFICITY_MATRIX, \
    XR_GENE_DIMENSION
...
def xr_make_gene_spec_heatmap(
    ...
    if isinstance(plot_mode, GeneNormalizedPlotMode):
        ds[XR_SPECIFICITY_MATRIX]  =ds[XR_SPECIFICITY_MATRIX]/ ds[XR_SPECIFICITY_MATRIX].sum(dim=XR_TISSUE_DIMENSION)
