...
from mecfs_bio.build_system.data_manipulation.pipes.xr_cluster import XRCluster
from mecfs_bio.build_system.data_manipulation.pipes.xr_composite import XRCompositePipe
from mecfs_bio.build_system.data_manipulation.pipes.xr_data_pipe import XRDataPipe
from mecfs_bio.build_system.data_manipulation.pipes.xr_most_significant import XRMostSignificant
from mecfs_bio.build_system.data_manipulation.pipes.xr_signifiance_filter import XRSignifianceFilter
from mecfs_bio.build_system.data_manipulation.xr_gene_dataset import gene_spec_df_to_da,XR_SPECIFICITY_MATRIX, XR_TISSUE_DIMENSION, XR_GENE_DIMENSION
from mecfs_bio.build_system.data_manipulation.xr_gene_dataset_load import SpecificityMatrixSource, GeneInfoSource, \
    TissueInfoSource, load_xr_gene_tissue_dataset
from mecfs_bio.build_system.data_manipulation.xr_gene_specificity_heatmap import XRHeatmapPlotMode, \
    xr_make_gene_spec_heatmap, XRHeatmapPlotSpec, GeneNormalizedPlotMode
...
class ExpressionMatrixClusterMapTaskV2(Task):
    ...
    @classmethod
    def create_standard_gene_magma_heatmap(cls,
                asset_id: str,
        ...
        return cls(
            ...
            gene_info_sources=[extracted_magma_gene_results_source, gene_thesaurus_source],
            tissue_info_sources=[],
