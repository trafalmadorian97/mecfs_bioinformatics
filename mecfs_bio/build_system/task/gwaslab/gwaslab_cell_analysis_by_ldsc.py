...
"Heritability enrichment of specifically expressed genes identifies disease-relevant tissues and cell types"
    ...
    def execute(self, scratch_dir: Path, fetch: Fetch, wf: WF) -> Asset:
        ...
        ref_ld_chr_cts_full_path = ref_ld_chr_cts_asset.path / self.ref_ld_chr_cts_filename
        assert ref_ld_chr_cts_full_path.is_file()
        ...
        sumstats.estimate_h2_cts_by_ldsc(
            ...
            ref_ld_chr_cts=  str(ref_ld_chr_cts_full_path),
    ...
    w_ld_chr_inner_dirname: str,
        ...
        return cls(
            ...
            ref_ld_chr_cts_filename=ref_ld_chr_cts_filename,
...
def prepend_path_to_ldcts_file(input_path: Path, output_path: Path):
    pass