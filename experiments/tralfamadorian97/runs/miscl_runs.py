...
from mecfs_bio.assets.gwas.height.yengo_2022.analysis.yengo_standard_analysis import YENGO_STANDARD_ANALYSIS
...
def run_miscl_analysis():
    ...
    # [
        # LDL_MI_LCV_ANALYSIS,
        # [MI_LCV_PLOT]
        [YENGO_STANDARD_ANALYSIS.heritability_markdown_task_unwrap]
