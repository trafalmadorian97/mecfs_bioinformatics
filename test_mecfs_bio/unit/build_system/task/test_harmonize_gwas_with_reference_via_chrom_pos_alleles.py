...
def test_harmonize_gwas_with_reference_via_chrom_pos_alleles(tmp_path: Path):
    dummy_gwas = pd.DataFrame(
        [
            ...
            },
            {
                ...
                GWASLAB_BETA_COL: 0.1,  # drop, since palindromic and no frequency info
            },
            {
    ...
    scratch_dir.mkdir()
    tsk = HarmonizeGWASWithReferenceViaAlleles(
