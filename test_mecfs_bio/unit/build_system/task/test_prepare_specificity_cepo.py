...
from mecfs_bio.build_system.task.prepare_specificity_cepo import PrepareSpecificityCepo, DIFFERENTIAL_STABILITY
...
def test_prepare_specificity_cepo(tmp_path:Path):
    ...
    tsk = PrepareSpecificityCepo(
        ...
        long_count_df_task=FakeTask(SimpleFileMeta("count_df",
    ...
    pivoted = result_df.pivot(index="cell_type",columns="gene", values=DIFFERENTIAL_STABILITY)
