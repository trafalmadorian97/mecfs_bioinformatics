...
For each SNP, we compute a quantity called [Linkage-Disequilibrium](Linkage_Disequilibrium.md) Score, or LD score, which measures the strength of the correlation between this SNP and other SNPs.  Two insights are central:
...
&\approx \frac{h^2}{M}l_jN+1 \label{main_ld_eq} \\
\end{align}
$$
