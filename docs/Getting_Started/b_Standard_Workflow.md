...
Use [checkout](https://git-scm.com/docs/git-checkout) to create a new [branch](https://git-scm.com/book/en/v2/Git-Branching-Branches-in-a-Nutshell) for your changes.  
...
[^winters_chapter]: The chapter on testing can be found [here](https://abseil.io/resources/swe-book/html/ch12.html).