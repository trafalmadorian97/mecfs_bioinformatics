...
Plots and tables are important to the presentation of data science results.  The `mecfs_bioinformatics` repo is transitioning to programmatic system for managing plots and tables (referred to as "figures").  The components of this system are:
