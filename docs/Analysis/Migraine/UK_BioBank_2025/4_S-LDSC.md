...
In the ImmGen dataset, there were no significant cell types. The cell type with the lowest p value is shown below.
...
Similarly, there were no significant tissues when testing the GTEx brain tissues using S-LDSC. The most significant tissue is presented below.
