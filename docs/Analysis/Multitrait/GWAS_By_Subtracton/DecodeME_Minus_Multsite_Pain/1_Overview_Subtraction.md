...
I then analyzed the remainder trait $R$ using my standard suite for post-GWAS analyses.   Previously, [we observed](../../Cross-trait_Correlation/CT-LDSC_Study.md) a high [genetic correlation](../../../../Bioinformatics_Concepts/Genetic_Correlation.md) between multisite pain and ME/CFS, and a high degree of concordance between local significance patterns of the two GWAS.  Despite this genetic correlation, it is clear that ME/CFS and multsite pain are distinct conditions. By studying $R$, that part of ME/CFS that is independent of multisite pain, I aimed to find genetics underlying the distinction between the two conditions.
