...
{{ plotly_embed(" said_et_al_2022_crp_eur_magma_bar_plot copied to docs/_figs/said_et_al_2022_crp_eur_magma_bar_plot/magma_gene_set_plot.html", id="said-crp-gtex-magma", caption="Result of MAGMA GTEx applied to Said et al.'s CRP GWAS. The x axis corresponds to tissue type, while the y axis measures MAGMA significance level.") }}
