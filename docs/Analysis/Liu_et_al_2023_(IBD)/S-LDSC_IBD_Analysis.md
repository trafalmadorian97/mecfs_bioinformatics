...
The significance of lung tissue may reflect sample contamination: as noted by Finucane et al.[@finucane2018heritability], there was likely blood in the lungs of the post-mortem donors from which the GTEx samples were extracted.

### Roadmap Chromatin data

I next applied S-LDSC to the IBD GWAS using reference data generated by Finucane et al.[@finucane2018heritability] from the [Roadmap Epigenetics Project](../../Data_Sources/Roadmap.md)
