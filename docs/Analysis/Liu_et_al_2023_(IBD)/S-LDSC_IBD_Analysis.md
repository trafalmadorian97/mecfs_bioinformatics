...
I next applied S-LDSC to the IBD GWAS using reference data generated by Finucate et al. from the [Roadmap Epigenetics Project](../../Data_Sources/Roadmap_Epigenetic_Project/Roadmap.md)
...
To reproduce, run the IBD  analysis script [here][mecfs_bio.analysis.bd_analysis]
