...
I applied MAGMA analysis to the Verweiji et al.'s GWAS of heart rate recovery after exercise[@verweij2018genetic], using [GTEx bulk RNAseq data](../../Data_Sources/GTEx_RNAseq_Data.md)[@gtex2020gtex] as a reference.


# Results

The results are shown in the bar plot below:
![verweiji_gtex_magma](https://github.com/user-attachments/assets/7188fcdc-2f08-4213-b9d5-8876160b9325)
