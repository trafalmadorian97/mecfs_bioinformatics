...
{{ plotly_embed("../../../_figs/xue_whole_brainstem_hba_magma_plot_extracted.html", id="xue-whole-brainstem-hba-magma", caption="Result of HBA MAGMA applied to Xue et al.'s wole brainstem volume GWAS. The x-axis corresponds to HBA cluster number, while the y-axis corresponds to the negative log p value generated by MAGMA. Clusters are colored according to their HBA supercluster. The dotted line denotes the Bonferroni significance threshold.") }}
