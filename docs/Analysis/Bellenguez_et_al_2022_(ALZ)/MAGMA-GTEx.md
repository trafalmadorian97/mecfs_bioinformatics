...
I applied MAGMA to the Alzhiemer's GWAS of Bellenguez et al. using a reference dataset derived from [GTEx bulk RNAseq data](../../Data_Sources/GTEx_RNAseq_Data.md).  The gene-property analysis results are plotted in the bar plot below.
