...
I applied [MAGMA](../../Bioinformatics_Concepts/MAGMA_Overview.md) to the Alzheimer's GWAS of Bellenguez et al.[@bellenguez2022new] using a reference dataset derived from [GTEx bulk RNAseq data](../../Data_Sources/GTEx_RNAseq_Data.md)[@gtex2020gtex].  The gene-property analysis results are plotted below.
