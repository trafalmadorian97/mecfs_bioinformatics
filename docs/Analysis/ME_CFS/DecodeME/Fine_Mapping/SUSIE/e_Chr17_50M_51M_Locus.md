...
{{ static_img_embed("docs/_figs/decode_mechr17_50000000_51000000_palindromes_keep_upset_plot_pip001.png", alt="chr_17_pip001") }}


The stackplot below, for the $L=10$ case, illustrates the typical PIP pattern across variants.

{{ static_img_embed("docs/_figs/decode_mechr17_50000000_51000000_palindromes_keep_susie_stackplot.png", alt="chr17_stackplot") }}
